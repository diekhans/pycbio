...
* Psl and genePred class should allow extra columns
...
*  --log-level LOG_LEVEL
CRITICALSet level to case-insensitive symbolic value,
one of: , FATALSet level to case-insensitive symbolic
value, one of: , ERRORSet level to case-insensitive
symbolic value, one of: , WARNSet level to case-
insensitive symbolic value, one of: , WARNINGSet level
to case-insensitive symbolic value, one of: , INFOSet
level to case-insensitive symbolic value, one of: ,
DEBUGSet level to case-insensitive symbolic value, one
of: , NOTSET
