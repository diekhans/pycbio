...
* add function to merge range finder entries
kznf-gene-homology/builds/2022-09/analysis/lib/znfAnalyze/__init__.py
LociRanges

* rangeFinder:
is this right, not sure this does an is test of value.
bucket.remove(Entry(start, end, value))
...
* BrowserDir
** subrows could use HTML tables in tables and be much cleaner
