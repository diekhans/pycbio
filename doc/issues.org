...
* make ObjDict use it's dictionary an abc.mutuablemapping to make more efficient.  See how this works with jsonpickle which makes an extra empty __dict__ for ObjDict derived classes.
* drop enumeration
