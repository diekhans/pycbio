...
* xlsx
convert xlsx-to-tsv to use CLI and logging stuff
add ~/compbio/kznf/projs/notch2nl/t2t-h9-paper/bin/tsvs-to-xlsx
...
** TSV writing with predefine column names and types
via a TsvRow
via a function with keyword args
