...
class ConfigInPyTests(TestCaseBase):
    def testConfigFuncCall(self):
        ...
        self.failUnlessMatch(c.configPyFile, ".*/input/funcBasic.config.py")
    ...
    def testConfigFuncArgs(self):
        ...
        self.failUnlessMatch(c.configPyFile, ".*/input/funcArgs.config.py")
    ...
    def testConfigObjBasic(self):
        ...
        self.failUnlessMatch(c.configPyFile, ".*/input/objBasic.config.py")
